...
async function main() {
  ...
  const STANDARD_ERC20_FACTORY_ADDR = addressFile.get("ScrollStandardERC20Factory");
  const L1_STANDARD_ERC20_GATEWAY_ADDR = addressFileL1.get("L1StandardERC20Gateway.proxy");
