...
// GetBatchToProve is a free data retrieval call binding the contract method 0x5704f90a.
//
// Solidity: function getBatchToProve(uint256 step) view returns(uint256)
func (_ScrollChain *ScrollChainCaller) GetBatchToProve(opts *bind.CallOpts, step *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ScrollChain.contract.Call(opts, &out, "getBatchToProve", step)
...
//
// Solidity: function getBatchToProve(uint256 step) view returns(uint256)
func (_ScrollChain *ScrollChainSession) GetBatchToProve(step *big.Int) (*big.Int, error) {
	return _ScrollChain.Contract.GetBatchToProve(&_ScrollChain.CallOpts, step)
}

// GetBatchToProve is a free data retrieval call binding the contract method 0x5704f90a.
//
// Solidity: function getBatchToProve(uint256 step) view returns(uint256)
func (_ScrollChain *ScrollChainCallerSession) GetBatchToProve(step *big.Int) (*big.Int, error) {
	return _ScrollChain.Contract.GetBatchToProve(&_ScrollChain.CallOpts, step)
}
