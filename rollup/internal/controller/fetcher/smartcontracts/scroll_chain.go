...
// IsCommitProofAllowed is a free data retrieval call binding the contract method 0x8e909d45.
//
// Solidity: function _isCommitProofAllowed(uint256 batchIndex) view returns(uint8)
func (_ScrollChain *ScrollChainCaller) IsCommitProofAllowed(opts *bind.CallOpts, batchIndex *big.Int) (uint8, error) {
	var out []interface{}
	err := _ScrollChain.contract.Call(opts, &out, "_isCommitProofAllowed", batchIndex)
...
//
// Solidity: function _isCommitProofAllowed(uint256 batchIndex) view returns(uint8)
func (_ScrollChain *ScrollChainSession) IsCommitProofAllowed(batchIndex *big.Int) (uint8, error) {
...
//
// Solidity: function _isCommitProofAllowed(uint256 batchIndex) view returns(uint8)
func (_ScrollChain *ScrollChainCallerSession) IsCommitProofAllowed(batchIndex *big.Int) (uint8, error) {
	return _ScrollChain.Contract.IsCommitProofAllowed(&_ScrollChain.CallOpts, batchIndex)
}
...
// GetBatchToProve is a free data retrieval call binding the contract method 0xaa67731e.
//
// Solidity: function getBatchToProve(uint256 _from, uint256 _step) view returns(uint256)
func (_ScrollChain *ScrollChainCaller) GetBatchToProve(opts *bind.CallOpts, _from *big.Int, _step *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ScrollChain.contract.Call(opts, &out, "getBatchToProve", _from, _step)
...
//
// Solidity: function getBatchToProve(uint256 _from, uint256 _step) view returns(uint256)
func (_ScrollChain *ScrollChainSession) GetBatchToProve(_from *big.Int, _step *big.Int) (*big.Int, error) {
	return _ScrollChain.Contract.GetBatchToProve(&_ScrollChain.CallOpts, _from, _step)
}

// GetBatchToProve is a free data retrieval call binding the contract method 0xaa67731e.
//
// Solidity: function getBatchToProve(uint256 _from, uint256 _step) view returns(uint256)
func (_ScrollChain *ScrollChainCallerSession) GetBatchToProve(_from *big.Int, _step *big.Int) (*big.Int, error) {
	return _ScrollChain.Contract.GetBatchToProve(&_ScrollChain.CallOpts, _from, _step)
}
...
//
// Solidity: function isCommitProofHashAllowed(uint256 batchIndex) view returns()
func (_ScrollChain *ScrollChainCaller) IsCommitProofHashAllowed(opts *bind.CallOpts, batchIndex *big.Int) error {
	var out []interface{}
...
//
// Solidity: function isCommitProofHashAllowed(uint256 batchIndex) view returns()
func (_ScrollChain *ScrollChainSession) IsCommitProofHashAllowed(batchIndex *big.Int) error {
...
//
// Solidity: function isCommitProofHashAllowed(uint256 batchIndex) view returns()
func (_ScrollChain *ScrollChainCallerSession) IsCommitProofHashAllowed(batchIndex *big.Int) error {
	return _ScrollChain.Contract.IsCommitProofHashAllowed(&_ScrollChain.CallOpts, batchIndex)
}
